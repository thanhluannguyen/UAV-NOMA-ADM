...
figure;
semilogy(PmaxdB, OP_ADM_E_ANA, '-', 'Color', blue1); hold on;
semilogy(PmaxdB, OP_ADM_C1_ANA, '--', 'Color', blue1); hold on;
semilogy(PmaxdB, OP_ADM_C2_ANA, '-.', 'Color', blue1); hold on;

semilogy(PmaxdB, OP_ADM_E_SIM, 'd', 'Color', blue1); hold on;
semilogy(PmaxdB, OP_ADM_C1_SIM, 'd', 'Color', blue1); hold on;
semilogy(PmaxdB, OP_ADM_C2_SIM, 'd', 'Color', blue1); hold on;
