...
save('Throughput_ADM_slowMov.mat','Throughput_ADM');
save('Throughput_NADM_CC_slowMov.mat','Throughput_NADM_CC');
save('Throughput_NADM_EC_slowMov.mat','Throughput_NADM_EC');
save('Throughput_NADM_CE_slowMov.mat','Throughput_NADM_CE');
save('Throughput_NADM_EE_slowMov.mat','Throughput_NADM_EE');
